...
contract CreateSubscription is Script {
    ...
    function createSubscription(address vrfCoordinator) public returns (uint64) {
        ...
        console.log("Use subscrptionId in HelperConfig.sol.");
...
contract FundSubscription is Script {
    ...
    function fundSubscriptionUsingConfig() public {
        ...
        (, ,address vrfCoordinatorV2, ,uint64 subId, , address link, uint256 deployerKey) = helperConfig.activeNetworkConfig();
...
contract AddConsumer is Script {
    ...
    function addConsumerUsingRaffle(address raffle) public {
        HelperConfig helperConfig = new HelperConfig();
